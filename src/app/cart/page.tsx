          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            ...
            <p
              className={`text-xs sm:text-sm font-medium ${
                totalPrice < 500 ? "text-red-600 animate-pulse" : "text-green-600"
              }`}
            >
              {totalPrice < 500 
                ? "Minimum cart value should be ₹500" 
                : "You are eligible for checkout 🎉"}
            </p>
            ...
            <button
              ...
              className={`w-full sm:w-auto px-4 sm:px-6 py-2 rounded-xl font-semibold transition 
                ${
                  totalPrice < 500
